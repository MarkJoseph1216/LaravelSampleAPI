...
<html>
    ...
    <body>
        <div class="container">
            <div>
                <h1>Daku International Company</h1>
                <p>This website is currently under maintenance. We will be back online soon.</p>
            </div>
            <div class="picture_bg">
                <!-- Please retain the copyright tag below if using this image  -->
                <p class="text-footer"><small><i class="far fa-copyright"></i> Daku International @2022</small></p>
            </div>
        </div>
        <!-- font awesome -->
